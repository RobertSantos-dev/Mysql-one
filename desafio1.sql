DROP DATABASE IF EXISTS SpotifyClone;
  ...
  CREATE TABLE SpotifyClone.plans(
    ...
    value_plan DECIMAL(3, 2)
  ) engine = InnoDB;

  INSERT INTO SpotifyClone.plans (plan_name, value_plan)
  VALUES
    ('gratuito', 0.00),
    ('familiar', 7.99),
    ('univeritário', 5.99),
  ...
  INSERT INTO SpotifyClone.users (user_name, user_age, user_date, plan_id)
  VALUES
  ...
  INSERT INTO SpotifyClone.albuns (album_name, r_year, artist_id)
  VALUES
    ('Renaissance', 2022, 1),
    ('Jazz', 1978, 2),
    ('Hot Space', 1982, 2),
  ...
  INSERT INTO SpotifyClone.songs (song_name, song_seconds, album_id)
  VALUES
    ('BREAK MY SOUL', 279, 1),
    ('VIRGO`S GROOVER', 369, 1),
  ...
  INSERT INTO SpotifyClone.reproductions_history (reproduction_date, user_id, song_id)
  VALUES
    ('2022-02-28 10:45:55', 1, 8),
    ('2022-08-05 08:09:17', 1, 2),
    ('2022-09-10 09:10:18', 1, 10),
